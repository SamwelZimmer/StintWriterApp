...
export default function Form() {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            // TODO: handle error with react toast
        }
    };
                ...
                <div className="flex sm:items-end sm:justify-end col-start-1 sm:col-start-3 w-full">
                    <div className="flex flex-col w-full sm:w-min">
                        ...
                        <input
                            ...
                            className="p-2 w-full sm:self-end shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        />
                    </div>
                </div>
            </div>
